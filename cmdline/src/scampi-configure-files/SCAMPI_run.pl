...
system("python2 $scampi_dir/fasta_split.py $tmpdir/$infile $tmpdir/sequences fasta 0");
...
system("python2 $scampi_dir/parse_topo_xml.py $tmpdir/outfile.xml $outfile_withpath $tmpdir/");
