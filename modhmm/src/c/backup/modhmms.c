...
//	printf("aa: %c  -  i: %i  -  helix: %i\n",aa,i,helix_length);
	...
	const long double profiles[26] ={	1.80, //A
						0,
						2.50, //C
						-3.50,//D
						-3.50,//E
	...
	int aa_nr = (int) (aa-65);
//	printf("Number aa: %i  -  profile: %Lf  -  char: %c\n",aa_nr,profiles[aa_nr],aa);
	return profiles[aa_nr];
...
long double pos_spec_DG_globmem(char aa, int i, int helix_length) 
{
	// Stephen H. White, William C. Wimley (1999), 
	// MEMBRANE PROTEIN FOLDING AND STABILITY: Physical Principles
	const long double profiles[26] ={	0.17, //A
						0,
						-0.24, //C
						-0.07,//D
						-0.01,//E
...
long double pos_spec_DG_globmem(char aa, int i, int helix_length) 
{
	// Stephen H. White, William C. Wimley (1999), 
	// MEMBRANE PROTEIN FOLDING AND STABILITY: Physical Principles
	const long double profiles[26] ={	10, //A
						10,
						10, //C
						10,//D
						10,//E
